        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, page.goto('https://tarkov-market.com/')];
                case 3:
                    // Replace the URL below with the URL of the website you want to access
                    _a.sent();
                ...
                case 4:
                    ...
                    return [4 /*yield*/, page.waitForSelector('span.price-main')];
                case 5:
                    // Wait for the presence of the element you want to scrape
                    _a.sent();
                    i = 0;
                ...
                case 6:
                    ...
                    return [4 /*yield*/, scrollAndLoad(page)];
                case 7:
                    _a.sent();
                    _a.label = 8;
                case 8:
                ...
                case 9: return [4 /*yield*/, page.evaluate(function () {
                        var priceElements = Array.from(document.querySelectorAll('span.price-main'));
                        return priceElements.map(function (el) { return el.textContent; });
                    })];
                case 10:
                    prices = _a.sent();
                    console.log(prices);
